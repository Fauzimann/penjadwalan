...
<div class="btn-group">
  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:#000000;">
    Menu
  </button>
  <div class="dropdown-menu">
    ...
    <a  href="user/laporan.php" class="dropdown-item" style="text-decoration: none;">Laporan Kegiatan</a>
  </div>
</div>
