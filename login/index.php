...
<div class="login-box" style="margin-center;">
    ...
    <div class="card-body">
      ...
      <form id="quickForm" action="proses_login.php" method="POST">
                ...
                <div class="form-group input-group mb-3">
                  <input type="nama" class="form-control" placeholder="Masukan Username" name="nama">
        ...
        <label for="exampleInputEmail1">Password</label>
                  ...
                  <input type="password" name="pass" class="form-control" id="password" required>
                        <span class="input-group-text bg-transparent border-start-0">
                         <i class="far fa-eye" id="toggle"   placeholder="Masukan Password" onclick="togglePassword()"></i>
                         </span>
            </div>
